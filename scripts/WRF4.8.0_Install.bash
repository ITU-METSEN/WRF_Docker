...
#  To execute this script "bash WRF4.8.0_Install.bash"	#
#########################################################
# Modified by: ITU-METSEN 
# Date: 2026
# Changes: Updated repository references and adapted for 
# Docker build context.
#########################################################
GEOG_validation="no"
prep_chem_validation="no"
#########################################################
WRFversion="4.8.0"
type="ARW"
if [ -n "$1" ]; then
...
sed -i "s# geog_data_path.*# geog_data_path = '/home/wrfuser/WPS_GEOG/'#" namelist.wps
cd ..
#########################################
